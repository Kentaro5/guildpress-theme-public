...
<div class="col-xs-12 col-md-4 post-lists">
    <div class="single-post-box lesson-bg-lock">
            ...
            <div class="center">
                ...
                <?php if (!empty($gp_data['post_thumb'])) : ?>
                    ...
                    <img class="single-post-thumbnail"
                         src="<?php echo $this->wpfunc->esc_url($gp_data['post_thumb']); ?>" style="width: 100%;">

                <?php else : ?>

                    <img class="single-post-thumbnail" src="<?php echo $gp_data['no_image']; ?>" alt=""
                         style="width: 100%;">
                <?php endif; ?>
