...
<div id="guild_press_register_form">
    ...
    <form action="" name="f1" id="payment-form" method="post" >
        ...
        <div class="form-group">
            ...
            <font color="red">*</font>
            <input type="text" name="user_email" id="user_email" class="form-control" value="<?php echo $this->wpfunc->esc_html( $gp_data['user_email'] ); ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="paypal_setting_id" value="<?php echo $gp_data['paypal_id']; ?>" class="form-control">
            <input type="hidden" name="global_post_id" value="<?php echo $gp_data['global_post_id']; ?>" class="form-control">
            <input type="hidden" name="guild_press_paypal_action" value="paypal_user_register" class="form-control">
